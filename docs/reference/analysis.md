...
| Settlement outcomes            | 26      | Committed/Bypassed/Blocked/Redirected/Cancelled for sync + async paths, leave guard combos, idle replay, failed redirects |
