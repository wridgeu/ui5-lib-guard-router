...
TanStack explicitly passes `ignoreBlocker: true` when handling redirects. `ui5.guard.router` achieves the same with the committing/redirect phase. Both prevent infinite redirect loops.
