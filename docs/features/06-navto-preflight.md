...
| Decision                  | Choice                                                                                          |
| ------------------------- | ----------------------------------------------------------------------------------------------- |
| Preflight flag            | Committing/preflight phase: lightweight, matches `_suppressedHash` pattern                      |
...
| Guard execution count     | Exactly once per navigation via the committing/preflight phase handshake                        |
